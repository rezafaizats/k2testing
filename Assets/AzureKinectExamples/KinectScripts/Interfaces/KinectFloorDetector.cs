...
namespace com.rfilkov.kinect
{
    ...
    public class KinectFloorDetector
    {
        ...
        private bool isFloorDetectorInited = false;


        /// <summary>
        /// Checks if the floor-detector is initialized or not.
        /// </summary>
        /// <returns>true if the floor detector is initialized, false otherwise</returns>
        public bool IsInitialized()
        {
            return isFloorDetectorInited;
        }
        ...
        private IEnumerator UpdateFloorAsync()
        {
            while(isRoutineRunning)
            {
                ...
                UnityEngine.Rendering.AsyncGPUReadback.Request(planePosNormBuffer, request =>
                {
                    request.GetData<float>().CopyTo(planePosNorm);
