...
namespace com.rfilkov.kinect
{
    ...
    public class KinectInterop
    {
        ...
        public class SensorDeviceInfo
        {
            ...
            public override string ToString()
            {
                return $"{sensorName}, id: {sensorId}, di: {deviceIndex}";
            }
        }
...
//            public Vector2[] color2DepthFrame = null;
        ...
        public static bool LoadSensorIntrExtr(SensorData sensorData)
        {
            ...
            string filePath = string.Format("{0}IE-{1}-{2}-{3}-{4}-{5}-{6}.json", saveFolder, sensorData.sensorIntPlatform.ToString(), sensorData.sensorId,
